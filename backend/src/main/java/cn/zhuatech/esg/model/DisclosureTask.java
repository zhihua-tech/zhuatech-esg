...
@Entity @Table(name="esg_disclosure_task") public class DisclosureTask extends BaseEntity {
    ...
    @ManyToOne(optional=false,fetch=FetchType.LAZY) private ReportingScope reportingScope; @Column(nullable=false) private int plannedQty; @Column(nullable=false) private int completedQty; @Column(nullable=false) private int defectQty;
