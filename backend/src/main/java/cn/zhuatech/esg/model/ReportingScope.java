...
@Entity @Table(name="esg_reporting_scope") public class ReportingScope extends BaseEntity {
    ...
    protected ReportingScope(){} public ReportingScope(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
